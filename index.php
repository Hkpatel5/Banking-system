...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #82E0AA;">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img src="bank1.png" class="img-fluid pt-2">
              </div>
            </div>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    <img src="user.png" class="img-fluid" style="width: 290px;">
                    <br>
                    <a href="createuser.php"><button style="background-color : #2785C4;">Create a User</button></a>
                  </div>
                  <div class="col-md act">
                    <img src="transction.jpg" class="img-fluid">
                    <br>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>Harsh Patel</b> <br> sparks Foundation</p>
      </footer>
